...
public class SecurityConfigurer extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers(HttpMethod.POST, "/exercises").hasAnyAuthority("ADMIN", "OPERATOR")
                .antMatchers(HttpMethod.PUT, "/exercises/**").hasAnyAuthority("ADMIN", "OPERATOR")
                .antMatchers(HttpMethod.DELETE, "/exercises/**").hasAnyAuthority("ADMIN", "OPERATOR")
                .antMatchers(HttpMethod.POST,"/toggle").hasAnyAuthority("ADMIN")
                .antMatchers(HttpMethod.PUT,"/toggle").hasAnyAuthority("ADMIN")
                .antMatchers(HttpMethod.DELETE,"/toggle").hasAnyAuthority("ADMIN")
